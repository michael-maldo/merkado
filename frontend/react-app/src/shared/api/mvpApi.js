...
export const productsApi = {
  list: categoryId => data(apiClient.get("/products", { params: categoryId ? { categoryId } : {} })),
  ...
  stock: (id, quantity) => data(apiClient.patch(`/products/${id}/stock`, { quantity })),
  addOptionType: (id, optionType) => data(apiClient.post(`/products/${id}/option-types`, optionType)),
  addVariant: (id, variant) => data(apiClient.post(`/products/${id}/variants`, variant)),
  updateVariant: (id, variantId, variant) => data(apiClient.patch(`/products/${id}/variants/${variantId}`, variant)),
  variantStock: (id, variantId, quantity) => data(apiClient.patch(`/products/${id}/variants/${variantId}/stock`, { quantity }))
};

export const categoriesApi = {
  list: () => data(apiClient.get("/categories")),
  create: category => data(apiClient.post("/categories", category)),
  update: (id, category) => data(apiClient.patch(`/categories/${id}`, category)),
...
export const ordersApi = {
  list: status => data(apiClient.get("/orders", { params: status ? { status } : {} })),
  ...
  status: (id, status) => data(apiClient.patch(`/orders/${id}/status`, { status })),
  ...
  addDiscount: (id, discount) => data(apiClient.post(`/orders/${id}/discounts`, discount))
};
...
export const inventoryApi = {
  ...
  getVariant: variantId => data(apiClient.get(`/inventory/variants/${variantId}`)),
  movements: () => data(apiClient.get("/stock-movements")),
  adjust: (productId, quantity, note) => data(apiClient.patch(`/inventory/${productId}/adjust`, { quantity, note })),
  adjustVariant: (variantId, quantity, note) => data(apiClient.patch(`/inventory/variants/${variantId}/adjust`, { quantity, note })),
  reserve: (productId, quantity, note) => data(apiClient.post(`/inventory/${productId}/reserve`, { quantity, note })),
  reserveVariant: (variantId, quantity, note) => data(apiClient.post(`/inventory/variants/${variantId}/reserve`, { quantity, note })),
  release: (productId, quantity, note) => data(apiClient.post(`/inventory/${productId}/release`, { quantity, note })),
  releaseVariant: (variantId, quantity, note) => data(apiClient.post(`/inventory/variants/${variantId}/release`, { quantity, note }))
};
...
export const pricingApi = {
  ...
  update: (productId, price) => data(apiClient.patch(`/pricing/${productId}`, { price })),
  updateVariant: (variantId, price) => data(apiClient.patch(`/pricing/variants/${variantId}`, { price })),
  bands: () => data(apiClient.get("/discount-bands")),
  createBand: band => data(apiClient.post("/discount-bands", band)),
  updateBand: (id, band) => data(apiClient.patch(`/discount-bands/${id}`, band))
};
...
export const commissionApi = {
  ...
  updateRule: (id, rule) => data(apiClient.patch(`/commission-rules/${id}`, rule))
};
...
export const identityAdminApi = {
  ...
  assignRole: (id, roleId) => data(apiClient.post(`/users/${id}/roles`, { roleId })),
  removeRole: (id, roleId) => data(apiClient.delete(`/users/${id}/roles/${roleId}`)),
  ...
  createPermission: permission => data(apiClient.post("/permissions", permission))
};
