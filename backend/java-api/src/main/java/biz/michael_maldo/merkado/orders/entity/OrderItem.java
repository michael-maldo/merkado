...
@Entity @Table(schema = "orders", name = "order_items")
...
public class OrderItem {
    ...
    @ManyToOne(optional = false) @JoinColumn(name = "variant_id") private ProductVariant variant;
    @Column(nullable = false) private String spu;
    ...
    @Column(name = "variant_name", nullable = false) private String variantName;
    @JdbcTypeCode(SqlTypes.JSON) @Column(name = "variant_options", nullable = false, columnDefinition = "jsonb")
