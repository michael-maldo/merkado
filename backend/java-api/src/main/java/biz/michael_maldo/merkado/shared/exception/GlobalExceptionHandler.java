...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> conflict(
    ...
    String message =
      details != null && details.contains("uk_categories_sibling_name_ci")
  ...
  public ResponseEntity<ErrorResponse> invalidRefresh(
  ...
  public ResponseEntity<ErrorResponse> expiredRefresh(
